...
class LEDWorld(object):
    ...
    def draw(self, detected_objects, t):
        ...
        return map(
            lambda location: self._rgb_for_led(location, detected_objects, t),
            self.led_locations
        )
...
class LEDWorldBuilder(object):
    ...
    def build(self):
        # maybe sort locations. think about good structur
        # print self.led_locations
        return LEDWorld(self.led_locations)
    ...
    def add_led_strip(self, opc_start_index, led_count, start_x, start_y, end_x, end_y, z):
        ...
        for i in xrange(led_count):
            ...
            self.led_locations.append(
                LEDLocation(angle, distance, z, opc_start_index+i)
            )
        return self
    ...
    def add_led_circle(self, opc_start_index, led_count, radius, z):
        ...
        for i in xrange(led_count):
            self.led_locations.append(
                LEDLocation(angle_per_led*i, radius, z, opc_start_index+i)
            )
        return self
