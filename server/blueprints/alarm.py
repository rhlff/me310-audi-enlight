...
def show_ped_1():
    ...
    spot = LEDSpot(color, location, 4)
    get_led_controller().add_symbol(spot)
    get_led_controller().add_animation(spot, 'location', ObjectLocation(90, 1.0), 14.666)
    time.sleep(14.666)
...
def show_ped_2():
    ...
    spot = LEDSpot(color, location, 3)
    get_led_controller().add_symbol(spot)
    get_led_controller().add_animation(spot, 'location', ObjectLocation(90, 1), 6.0)
    time.sleep(6.0)
...
def show_car_1():
    ...
    get_led_controller().add_symbol(spot)
    get_led_controller().add_animation(spot, 'location_r', ObjectLocation(0, 3), 3.333)
    time.sleep(3.333)
    spot.dead = True
...
def show_bike_1():
    ...
    spot = LEDSpot(color, location, 2)
    get_led_controller().add_symbol(spot)
    get_led_controller().add_animation(spot, 'location', ObjectLocation(-90, 1), 4.666)
    time.sleep(6.166)
